...
| <a name="input_tfe_workspace_settings"></a> [tfe\_workspace\_settings](#input\_tfe\_workspace\_settings) | TFE Workspaces settings | <pre>object({<br>    oauth_token_id            = string<br>    global_remote_state       = bool<br>    remote_state_consumer_ids = set(string)<br>    repository_identifier     = string<br>    terraform_organization    = string<br>    terraform_version         = string<br>    working_directory         = string<br>  })</pre> | `null` | no |
